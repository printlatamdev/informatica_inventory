        ...
        if (isset($_POST['descargo'])) {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->execute()) {
                    ...
                    header("Location: http://localhost/HBARTOLO/Control_de_Equipos/equipos_microfono.php");
                    exit;
                } else {
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <a href="http://localhost/HBARTOLO/Control_de_Equipos/equipos_microfono.php" class="button back-button">Volver</a>
        </div>
    </div>
</body>
</html>