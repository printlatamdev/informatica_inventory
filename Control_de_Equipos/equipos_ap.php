...
<head>
    ...
    <title>Equipos AP - Hospital Nacional San Bartolo</title>
    <link rel="stylesheet" href="styles_equipos.css">
</head>
<body>
    <div class="container">
        <h1>EQUIPOS AP DEL HOSPITAL NACIONAL SAN BARTOLO</h1>
        ...
        <?php
            ...
            if (!$obj_conexion) {
                ...
                $total_query = "SELECT COUNT(*) as total FROM equipo WHERE tipo_equipo='Ap' 
                ...
                $var_consulta = "SELECT * FROM equipo WHERE tipo_equipo='Ap' 
                                 AND (tipo_equipo LIKE '%$search%' OR 
                                      nombre_host LIKE '%$search%' OR 
                                      num_serie LIKE '%$search%' OR 
                                      num_inventario LIKE '%$search%' OR 
